...
class attractionModels(models.Model):
    ...
    attractionLat = models.DecimalField(max_digits=10, decimal_places=6, verbose_name="attraction latitude" )
    attractionLng = models.DecimalField(max_digits=10, decimal_places=6, verbose_name="attraction longtitude")
